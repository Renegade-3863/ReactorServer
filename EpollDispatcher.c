...
int epollRemove(struct Channel *channel, struct EventLoop *evLoop)
{
...
int epollModify(struct Channel *channel, struct EventLoop *evLoop)
{
...
int epollDispatch(struct EventLoop *evLoop, int timeout)
{
    struct EpollData* data = (struct EpollData*)evLoop->dispatcherData;
...
int epollClear(struct EventLoop *evLoop)
{
    struct EpollData* data = (struct EpollData*)evLoop->dispatcherData;
    free(data->events);
    close(data->epfd);
